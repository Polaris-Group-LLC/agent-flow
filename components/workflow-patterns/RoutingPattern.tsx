      ...
      <div className="flex flex-col items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col items-center">
            <div className="rounded-full bg-foreground/10 p-3 mb-2 flex items-center gap-2">
              <GitBranch size={22} className="text-foreground" />
              <span className="text-sm">Router Agent</span>
            </div>
            <span className="text-xs text-foreground/70">Router</span>
          </div>
        </div>
        <div className="flex items-center gap-16 mt-4">
          <div className="flex flex-col items-center">
            ...
            <span className="text-xs text-foreground/70">Branch 1</span>
          </div>
          <div className="flex flex-col items-center">
            <ArrowRightCircle size={24} className="mb-2 text-foreground/60" />
            <div className="rounded-full bg-foreground/10 p-3 mb-2 flex items-center gap-2">
            ...
            <span className="text-xs text-foreground/70">Branch 2</span>
          </div>
        </div>
